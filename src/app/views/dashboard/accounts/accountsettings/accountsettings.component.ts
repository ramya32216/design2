...
import { StoreBasicDetails } from 'src/app/views/dashboard/store-profile/_model/store-basic-details';
...
export class AccountsettingsComponent implements OnInit {
  ...
  basicDetailspassword: FormGroup = new FormGroup({
  ...
  toggleEdit() {
    ...
    this.normalModes = !this.normalModes;
  }
  toggleEditPassword(){
    if (this.normalMode) {
      this.basicDetailCache = this.basicDetailspassword.value;
     // this.basicDetailCache.cuisines = [...this.basicDetailCache.cuisines];
    }
